...
<head>
    ...
    <title>Not Found | ki-admin - Premium Admin Template</title>
            ...
            <div class="mb-3">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 ">
                        <p class="text-center text-secondary f-w-500 mt-5">Website owners should regularly check for and
                            fix broken links using tools like Google Search Console or other link-checking software.</p>
                    </div>
                </div>
            </div>
            <a class="btn btn-lg btn-primary" href="/" role="button"><i class="ti ti-home"></i> Back To
                Home</a>
        </div>
    </div>
</div>
