@include('admin._inc._header', ['title' => 'Create Role'])
            ...
            <div class="col-12 ">
                ...
                <div class="col-6 ">
                    <ul class="app-line-breadcrumbs mb-3">
                        ...
                        <li class="active">
                            <a class="f-s-14 f-w-500" href="{{ route('roles.create') }}">Create Role</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" id="name" required type="text" value="{{ old('name') }}"
                                   name="name">
                            @error('name')
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" id="highlight" required type="color"
                                   value="{{ old('highlight') }}" name="highlight"
                        ...
                        <div class="col-12 mt-3">
                            <button class="btn btn-primary float-end" type="submit">Create Role</button>
                        </div>
