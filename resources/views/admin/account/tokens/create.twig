@include('admin._inc._header', ['title' => 'Create API Token'])
...
<main>
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-12 ">
                <h4 class="main-title">Create API Token</h4>
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a class="f-s-14 f-w-500" href="{{ route('account.tokens.create') }}">Create API Token</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('account.tokens.store') }}" class="row g-3 needs-validation" novalidate>
                                    @csrf
                                    <div class="col-md-12">
