@include('admin._inc._header', ['title' => 'Change Password'])
...
<main>
    <div class="container-fluid">
        ...
        <div class="row m-1">
            <div class="col-12 ">
                ...
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a class="f-s-14 f-w-500" href="{{ route('account.password.update') }}">Change Password</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <!-- setting-app start -->
        <div class="row">
            @include('admin.account._sidebar', ['active' => 'password'])
