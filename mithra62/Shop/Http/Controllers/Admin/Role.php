...
use mithra62\Shop\Actions\Actions\Role\CreateNewRole;
use mithra62\Shop\Actions\Actions\Role\EditRole;
use mithra62\Shop\Http\Controllers\Controller;
use mithra62\Shop\Http\Requests\Role\DeleteRoleRequest;
use mithra62\Shop\Http\Requests\Role\EditRoleRequest;
use mithra62\Shop\Http\Requests\Role\StoreRoleRequest;
...
class Role extends Controller
{
    ...
    public function confirm(string $id)
    {
        ...
        return view('roles.delete', ['role' => $user]);
    }
}
