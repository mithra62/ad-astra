...
use AdAstra\Traits\Field\HasDecimalStorage;
...
class Slider extends AbstractField
{
    ...
    protected array $settings_form = [
        'min' => [
            'type' => 'number',
            'label' => 'Minimum',
            'instructions' => 'Lower bound of the slider.',
            'default' => 0,
        ...
        'max' => [
            'type' => 'number',
            'label' => 'Maximum',
            'instructions' => 'Upper bound of the slider.',
            'default' => 100,
            'rules' => 'required|numeric'
        ],
        'step' => [
        ...
        'suffix' => [
            'type' => 'text',
            'label' => 'Suffix',
            'instructions' => 'Unit appended to displayed value, e.g. %, px, ★.',
            'default' => null,
        ...
        'decimals' => [
            ...
            'instructions' => 'Set to 0 for integers. Controls storage column.',
            'default' => 0,
        ...
        'default' => [
            'type' => 'slider',
            'label' => 'Default Value',
            'instructions' => 'Initial value when no entry data exists.',
            'default' => null,
