...
namespace AdAstra\Http\Controllers\Admin\Account;

use AdAstra\Actions\User\Token\CreateNewUserToken;
use AdAstra\Http\Controllers\Admin\Controller as AdminController;
use AdAstra\Http\Requests\Account\Token\DeleteAccountTokenRequest;
use AdAstra\Http\Requests\Account\Token\EditAccountTokenRequest;
use AdAstra\Http\Requests\Account\Token\StoreAccountTokenRequest;
