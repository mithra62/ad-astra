...
use AdAstra\Http\Resources\Api\CategoryGroupCollection;
use AdAstra\Http\Resources\Api\CategoryGroupResource;
use AdAstra\Models\Category\Group as CategoryGroupModel;
...
class CategoryGroups extends Controller
{
    ...
    // -------------------------------------------------------------------------
    // store — reuses existing AdAstra\Http\Requests\Category\Group\StoreCategoryGroupRequest
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // update — reuses existing AdAstra\Http\Requests\Category\Group\EditCategoryGroupRequest
    // -------------------------------------------------------------------------
