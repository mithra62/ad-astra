...
use AdAstra\Http\Resources\Api\StatusCollection;
use AdAstra\Http\Resources\Api\StatusResource;
...
class Statuses extends Controller
{
    ...
    // -------------------------------------------------------------------------
    // store — reuses AdAstra\Http\Requests\Status\StoreStatusRequest
    ...
    // -------------------------------------------------------------------------
    // update — reuses AdAstra\Http\Requests\Status\EditStatusRequest
