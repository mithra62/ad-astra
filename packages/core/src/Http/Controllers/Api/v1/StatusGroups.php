...
use AdAstra\Http\Requests\Status\Group\EditStatusGroupRequest;
use AdAstra\Http\Requests\Status\Group\StoreStatusGroupRequest;
use AdAstra\Http\Resources\Api\StatusGroupCollection;
use AdAstra\Http\Resources\Api\StatusGroupResource;
...
class StatusGroups extends Controller
{
    ...
    // -------------------------------------------------------------------------
    // store — reuses AdAstra\Http\Requests\Status\Group\StoreStatusGroupRequest
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // update — reuses AdAstra\Http\Requests\Status\Group\EditStatusGroupRequest
