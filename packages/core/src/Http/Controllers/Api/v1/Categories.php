...
use AdAstra\Http\Resources\Api\CategoryCollection;
use AdAstra\Http\Resources\Api\CategoryResource;
...
class Categories extends Controller
{
    ...
    // -------------------------------------------------------------------------
    // store — reuses existing AdAstra\Http\Requests\Category\StoreCategoryRequest
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // update — reuses existing AdAstra\Http\Requests\Category\EditCategoryRequest
    // -------------------------------------------------------------------------
