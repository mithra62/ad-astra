...
/**
 * Canonical definition of the roles and permissions an AdAstra installation
 * requires. RolesPermissionsSeeder seeds from this list and the doctor
 * permission checks verify against it — one source of truth, no drift.
 */
final class AccessSchema
{
     ...
     *
     * @return array<string, array<string, string>> domain => [name => description]
     */
    public static function permissions(): array
    {
        return [
            'users' => [
                'read user' => 'Allows for listing and reading users',
    ...
    {
        return ['super admin', 'user', 'admin'];
    }

    /**
     * Flat list of every permission name across all domains.
     *
     * @return list<string>
     */
